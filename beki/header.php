...
<head>
  ...
  <?php versioned_javascript($GLOBALS["TEMPLATE_RELATIVE_URL"]."html5-boilerplate/js/modernizr-1.7.min.js") ?>
...
<!--[if (gt IE 9)|!(IE)]><!--> <body <?php body_class('ie6'); ?>> <!--<![endif]-->
  ...
  <div id="container">
	<header role="banner">
		<h1>203.389.2108</h1>
		<h2>85 Harrison Street at Whalley Avenue, New Haven, CT 06515</h2>
	</header>
